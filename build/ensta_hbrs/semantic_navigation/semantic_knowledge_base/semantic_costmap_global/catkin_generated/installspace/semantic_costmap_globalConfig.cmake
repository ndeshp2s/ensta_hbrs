...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'semantic_costmap_global' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/brsu/catkin_ws/install/${idir}'.  Ask the maintainer 'niranjan <niranjan.deshpande187@gmail.com>' to fix it.")
    endif()
