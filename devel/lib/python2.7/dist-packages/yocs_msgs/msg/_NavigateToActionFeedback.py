...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2fb.pack(_x.feedback.distance, _x.feedback.remain_time, _x.feedback.status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.feedback.distance, _x.feedback.remain_time, _x.feedback.status,) = _struct_2fb.unpack(str[start:end])
      return self
