...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2b2f3I.pack(_x.action_goal.goal.approach_type, _x.action_goal.goal.num_retry, _x.action_goal.goal.timeout, _x.action_goal.goal.distance, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_Bf.pack(_x.action_result.result.success, _x.action_result.result.distance))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2fb.pack(_x.action_feedback.feedback.distance, _x.action_feedback.feedback.remain_time, _x.action_feedback.feedback.status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.approach_type, _x.action_goal.goal.num_retry, _x.action_goal.goal.timeout, _x.action_goal.goal.distance, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_2b2f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.success, _x.action_result.result.distance,) = _struct_Bf.unpack(str[start:end])
      ...
      (_x.action_feedback.feedback.distance, _x.action_feedback.feedback.remain_time, _x.action_feedback.feedback.status,) = _struct_2fb.unpack(str[start:end])
      return self
