...
semanticclear_costmap_recovery::SemanticClearCostmapRecovery clear = semantic_clear_costmap_recovery::SemanticClearCostmapRecovery();
...
if(static_map)
clearable_layers.push_back( std::string("static_layer") );
