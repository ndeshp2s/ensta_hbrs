...
namespace semantic_costmap
{
  ...
  bool ObservationBuffer::setGlobalFrame(const std::string new_global_frame)
  {
    ...
    list<costmap_2d::Observation>::iterator obs_it;
    for (obs_it = observation_list_.begin(); obs_it != observation_list_.end(); ++obs_it)
    {
      try
      {
        costmap_2d::Observation& obs = *obs_it;
  ...
  void ObservationBuffer::bufferCloud(const pcl::PointCloud<pcl::PointXYZ>& cloud)
  {
    ...
    observation_list_.push_front(costmap_2d::Observation());
  ...
  void ObservationBuffer::getObservations(vector<costmap_2d::Observation>& observations)
  {
  ...
  void ObservationBuffer::purgeStaleObservations()
  {
    ...
    {
      list<costmap_2d::Observation>::iterator obs_it = observation_list_.begin();
  ...
  bool ObservationBuffer::isCurrent() const
  {
    ...
    if (!current)
    {
      ROS_WARN("The %s observation buffer has not been updated for %.2f seconds, and it should be updated every %.2f seconds.",
