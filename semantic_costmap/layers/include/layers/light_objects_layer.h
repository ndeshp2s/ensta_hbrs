#ifndef LIGHT_OBJECTS_LAYER_H_
#define LIGHT_OBJECTS_LAYER_H_
...
namespace semantic_costmap
{
  ...
  class LightObjectsLayer : public costmap_2d::CostmapLayer
  {
  public:
     LightObjectsLayer() : light_objects_costmap_() 
     {
       costmap_ = NULL;
       light_objects_costmap_.setDefaultValue(0);
     }

     virtual ~LightObjectsLayer();
  ...
  //   nav_msgs::OccupancyGridConstPtr map;
     ...
     {
	return &light_objects_costmap_;
     }

  private:
    costmap_2d::Costmap2D light_objects_costmap_;
  };
}
#endif
