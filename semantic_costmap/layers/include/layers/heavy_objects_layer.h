#ifndef HEAVY_OBJECTS_LAYER_H_
#define HEAVY_OBJECTS_LAYER_H_
...
namespace semantic_costmap
{
  ...
  class HeavyObjectsLayer : public costmap_2d::CostmapLayer
  {
  public:
     HeavyObjectsLayer() : heavy_objects_costmap_() 
     {
       costmap_ = NULL;
       heavy_objects_costmap_.setDefaultValue(0);
     }

     virtual ~HeavyObjectsLayer();
  ...
  private:
    costmap_2d::Costmap2D heavy_objects_costmap_; 
  };
}
#endif
